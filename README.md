...
The interface includes four persistent, accessible color themes: Dawn, Midnight, Lotus, and a high-contrast mode. It also defaults to Midnight when the operating system requests a dark color scheme.
